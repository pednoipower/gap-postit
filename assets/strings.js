...
(function () {
  ...
  const S = {
    ...
    situ_lbl:         { th: "ตอนที่…",                        en: "when… (situation / condition)" },
    ...
    worked_cause:     { th: "“โรงพยาบาลยังไม่มีระบบคัดกรองผู้ป่วยที่เหมาะกับ CKM — <b>ยังเจอในงานของเรา</b>: <b>แพทย์โรคไต มักจะ</b> ไม่ได้ประเมินว่าใครเหมาะกับ CKM <b>ตอนที่</b> คลินิกไตวันพุธมีผู้ป่วย 80 ราย และมีแพทย์คนเดียว <b>เพราะ</b> ไม่มีเกณฑ์ที่ตกลงกันไว้ และไม่มีช่องให้บันทึกใน HIS”",
    ...
    gaps_intro:       { th: "ช่องว่าง 4 เรื่องที่ 16 โรงพยาบาลส่งมาก่อนวันนี้ — เราจะดูทีละเรื่องว่าทำไมจึงเกิดขึ้นและจะทำอย่างไร", en: "Four gaps from the pre-survey of 16 hospitals — one at a time: why it happens, then how to fix it" },
    ...
    pj_talk_sub:      { th: "คุยกัน 1 นาที ก่อนคิดว่าจะทำอะไร",                      en: "One minute, before we look for fixes" },
    ...
    pj_evidence:      { th: "ช่องว่างที่ 16 โรงพยาบาลบอกมา",                     en: "The gaps the evidence points to" },
    pj_evidence_sub:  { th: "จากคำตอบที่ส่งมาก่อนวันนี้",           en: "From the pre-survey of 16 hospitals" },
    pj_proposal:      { th: "ข้อเสนอ",                                    en: "Proposal" },
    pj_evidence_lbl:  { th: "ข้อมูลก่อนวันนี้",                             en: "From the pre-survey" },
