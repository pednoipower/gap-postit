...
(function () {
  ...
  const S = {
    ...
    // the fill-in-the-blank: WHO · WHEN · DOES · BECAUSE
    why_lead:         { th: "เติมให้ครบ — ประโยคเดียวที่ชี้ว่ามันพังตรงไหน",   en: "Fill in the blanks — one sentence that pins down where it breaks" },
    works_lead:       { th: "เติมให้ครบ — ประโยคเดียวที่ชี้ว่าทำไมที่คุณทำได้",  en: "Fill in the blanks — one sentence that pins down why it works for you" },
    who_lbl:          { th: "ใคร",                                         en: "Who" },
    when_lbl:         { th: "เมื่อ…",                                       en: "When…" },
    does_lbl:         { th: "มักจะ…",                                       en: "usually…" },
    does_works_lbl:   { th: "จะ…",                                          en: "will…" },
    because_lbl:      { th: "เพราะ…",                                       en: "because…" },
    when_hint:        { th: "สถานการณ์ไหน เช่น ผู้ป่วย stage 5 มาตามนัดที่ CKD clinic", en: "The situation, e.g. a stage-5 patient comes to CKD clinic" },
    does_hint:        { th: "ทำหรือไม่ทำอะไร เช่น ไม่ได้ถูกถามเรื่องทางเลือก",    en: "Does or doesn't do what, e.g. isn't asked about options" },
    does_works_hint:  { th: "ทำอะไร เช่น ถูกถาม surprise question ทุกครั้ง",      en: "Does what, e.g. gets the surprise question every visit" },
    because_hint:     { th: "เหตุผล หรือสิ่งที่ขาด เช่น ไม่มีใครถูกกำหนดให้ถาม และคิวยาว", en: "The reason, or what's missing, e.g. nobody is assigned to ask, and the queue is long" },
    because_works_hint:{ th: "เหตุผล หรือสิ่งที่มี เช่น มีช่องในแบบบันทึก และหัวหน้าดูทุกเดือน", en: "The reason, or what's there, e.g. there's a box on the form and the head checks monthly" },
