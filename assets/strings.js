...
(function () {
  ...
  const S = {
    ...
    // the overall round: what to do with what we already do
    ov_pick:          { th: "สิ่งที่คุณเสนอคือ",                                en: "What you're proposing is" },
    ov_promote:       { th: "ส่งเสริม",                                        en: "Promote" },
    ov_improve:       { th: "ปรับปรุง",                                        en: "Improve" },
    ov_stop:          { th: "ยกเลิก",                                          en: "Stop" },
    ov_what_promote:  { th: "เช่น เวทีทบทวนผู้ป่วยร่วมสองทีมที่ทำอยู่แล้ว",        en: "e.g. the joint case review the two teams already hold" },
    ov_why_promote:   { th: "เช่น ทำให้สองทีมรู้จักกันก่อนจะมีเคสด่วน",            en: "e.g. the two teams know each other before an urgent case" },
    ov_what_improve:  { th: "เช่น แบบฟอร์มส่งต่อที่ยังกรอกยาก",                   en: "e.g. the referral form that is hard to fill in" },
    ov_why_improve:   { th: "เช่น ถ้าสั้นลง คนจะใช้จริง",                        en: "e.g. if it were shorter people would actually use it" },
    ov_what_stop:     { th: "เช่น การรอให้อาการทรุดก่อนจึงปรึกษา PC",             en: "e.g. waiting for deterioration before consulting PC" },
    ov_why_stop:      { th: "เช่น ทำให้เริ่มคุยกับครอบครัวช้าเกินไปทุกครั้ง",        en: "e.g. it makes the family conversation late every time" },
    ...
    pj_key_promote:   { th: "สีเขียว = ส่งเสริม",                               en: "green = promote" },
    pj_key_improve:   { th: "สีทอง = ปรับปรุง",                                 en: "gold = improve" },
    pj_key_stop:      { th: "สีแดง = ยกเลิก",                                   en: "red = stop" },
    pj_ov_promote:    { th: "ส่งเสริม",                                        en: "Promote" },
    pj_ov_improve:    { th: "ปรับปรุง",                                        en: "Improve" },
    pj_ov_stop:       { th: "ยกเลิก",                                          en: "Stop" },
