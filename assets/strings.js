...
(function () {
  ...
  const S = {
    ...
    situ_lbl:         { th: "เมื่อ… (สถานการณ์ / เงื่อนไข)",                        en: "when… (situation / condition)" },
    situ_sub:         { th: "เป็นแบบนั้นตอนไหน — ลองระบุเงื่อนไขที่ทำให้เกิดขึ้น",      en: "When is it like that? Name the conditions that bring it about" },
    ...
    situ_sub_works:   { th: "เป็นแบบนั้นตอนไหน — ลองระบุเงื่อนไขที่ทำให้ทำได้",        en: "When is it like that? Name the conditions that make it work" },
    ...
    worked_cause:     { th: "“โรงพยาบาลยังไม่มีระบบคัดกรองผู้ป่วยที่เหมาะกับ CKM — <b>ยังเจอในงานของเรา</b>: <b>แพทย์โรคไต มักจะ</b> ไม่ได้ประเมินว่าใครเหมาะกับ CKM <b>เมื่อ</b> วันพุธ คลินิกไตมีผู้ป่วย 80 ราย และมีแพทย์คนเดียว <b>เนื่องจาก</b> ไม่มีเกณฑ์ที่ตกลงกันไว้ และไม่มีช่องให้บันทึกใน HIS”",
    ...
    worked_works:     { th: "“… — <b>ไม่ค่อยเจอในงานของเรา</b>: <b>พยาบาลไต จะ</b> ชวนคุยเรื่องทางเลือกตั้งแต่ stage 4 <b>เมื่อ</b> คลินิกไตวันอังคารมีพยาบาล PC นั่งด้วยทุกสัปดาห์ <b>เนื่องจาก</b> มีช่องในแบบฟอร์ม และหัวหน้าดูทุกเดือน”",
    ...
    worked_cause_p:   { th: "“การประชุมมักจบช้ากว่าเวลาที่นัดไว้ — <b>ยังเจอในงานของเรา</b>: <b>ประธาน มักจะ</b> ปล่อยให้เลยเวลาโดยไม่ตัดบท <b>เมื่อ</b> ประชุมบ่ายสาม มีวาระ 8 เรื่อง และมีผู้บริหารอาวุโสนั่งอยู่ด้วย <b>เนื่องจาก</b> เกรงใจคนอาวุโสที่เตรียมมาพูด และไม่มีใครได้รับมอบหมายให้คุมเวลา”",
    ...
    worked_works_p:   { th: "“… — <b>ไม่ค่อยเจอในงานของเรา</b>: <b>เลขา/ผู้จัดประชุม จะ</b> เตือนเมื่อเหลือ 2 นาที แล้วปิดวาระ <b>เมื่อ</b> เป็นประชุมเช้าวันจันทร์ ที่ทุกคนต้องไปราวด์ต่อ 9 โมง <b>เนื่องจาก</b> ตกลงกติกาเวลากันไว้ล่วงหน้า และหัวหน้าทำตามเอง”",
