...
(function () {
  ...
  const S = {
    ...
    situ_hint:        { th: "เช่น ผู้ป่วย stage 5 มาตามนัดที่ CKD clinic",         en: "e.g. a stage-5 patient comes to CKD clinic" },
    ...
    because_hint:     { th: "เช่น ไม่มีเกณฑ์ ไม่มีช่องในแบบบันทึก และคิวยาว",        en: "e.g. no criteria, no box on the form, and the queue is long" },
