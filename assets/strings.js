...
(function () {
  ...
  const S = {
    ...
    situ_sub:         { th: "ที่ไหน · เมื่อไร · อะไรกำลังเกิดขึ้น",                   en: "where · when · what is going on" },
    who_lbl:          { th: "ใคร",                                            en: "Who" },
    does_lbl:         { th: "มักจะ…",                                          en: "usually…" },
    does_works_lbl:   { th: "จะ…",                                             en: "will…" },
    because_lbl:      { th: "เพราะ…",                                          en: "because…" },
    situ_hint:        { th: "เช่น วันพุธ คลินิกไต คนล้น 80 ราย / ER ตอนดึก ผู้ป่วยมาด้วย uremia / ทีม PC อยู่คนละตึก ไม่เคยเจอกัน", en: "e.g. Wednesday, renal clinic, 80 patients / ER at night, patient with uraemia / PC team in another building, never meet" },
