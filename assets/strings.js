...
(function () {
  ...
  const S = {
    ...
    pj_needs:         { th: "อุปสรรคที่ต้องจัดการ",                        en: "Obstacles to sort out" },
    ...
    pj_stats:         { th: "{c} เรื่องที่หลุด · {f} สิ่งที่จะช่วย · {b} อุปสรรค · {i} ไอเดีย · {g} ช่องว่างที่ทั้งสองทีมร่วมตอบ",
