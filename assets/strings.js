...
(function () {
  ...
  const S = {
    ...
    open_cause:       { th: "เนื่องจาก",                                      en: "because" },
    open_works:       { th: "ไม่เกิดที่ รพ. ของเรา เนื่องจาก",                    en: "does not happen at our hospital, because" },
    situ_lbl:         { th: "ในสถานการณ์…",                                   en: "In the situation…" },
    situ_sub:         { th: "เวลา · สถานที่ · ภาระงาน · นโยบาย/ตัวชี้วัด · ข้อมูล · ความสัมพันธ์ระหว่างทีม · เส้นทางผู้ป่วย", en: "time · place · workload · policy/KPIs · information · relationship between teams · the patient's path" },
    who_lbl:          { th: "ใคร",                                            en: "Who" },
    does_lbl:         { th: "มักจะ…",                                          en: "usually…" },
    does_works_lbl:   { th: "จะ…",                                             en: "will…" },
    because_lbl:      { th: "เพราะ…",                                          en: "because…" },
    situ_hint:        { th: "เช่น คลินิกไตวันพุธคนล้น 80 ราย / ทีม PC อยู่คนละตึก / นอกเวลาราชการ / ตัวชี้วัดนับแต่จำนวนคนที่ได้ฟอก / ผู้ป่วยมาจากอำเภอไกล มาครั้งเดียว", en: "e.g. Wednesday renal clinic has 80 patients / the PC team is in another building / after hours / the KPI counts dialysis starts / the patient is from a far district and comes once" },
    ...
    because_hint:     { th: "เช่น ไม่มีเกณฑ์ / ไม่มีช่องใน HIS / ไม่มีเวลา / กลัวครอบครัวเข้าใจว่า “ไม่รักษา” / คิดว่าเป็นหน้าที่อีกทีม", en: "e.g. no criteria / no box in the HIS / no time / afraid the family hears “no treatment” / thinks it's the other team's job" },
